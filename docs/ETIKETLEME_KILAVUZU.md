...
| 26 Ağu | `tahsis_ucreti` hem ORAN hem TL veriliyorsa? | **Oran yazılır.** TL tutarı örnek finansman tutarına bağlıdır (*«60 ay vadede 1000 TL»*), kampanyanın koşulu değildir; oran her tutarda geçerlidir (*«finansman tutarının binde 5'i»* → `0.5`). Örnek ödeme planı tablosundaki TL kolonu **kullanılmaz**. Altın setin 12 dolu hücresinin 10'u zaten böyle yazılmıştı; kural yazılmadığı için sistem tersini yapıyordu (`0206-016254a2c9b8`, `0206-58784db119eb`, `0206-61006b35204e`) |
| 26 Ağu | «Vade farksız N taksit» — hangi alanlar? | **İkisi birden:** `kar_payi_orani = 0` **ve** `vade_ay_max = N`. 15 Ağu'daki *«kâr payı sıfırsa 0 yaz»* kuralının uygulanmamış hali; 26 Ağu denetiminde iki kayıtta birden bulundu (`0213-8e662b576a6b` «Vade Farksız 12 Taksit» → `0`+`12`, `0205-a323f782dfd5` «vade farksız 5 taksit» → `0`+`5`). Taksit sayısı burada vadedir: müşteri N ay boyunca öder |
| 26 Ağu | «N aya varan» / «N aya kadar» vade? | **`vade_ay_max = N`.** Alan adı `_max`; *«varan/kadar»* üst sınırı ilan eder, belirsizlik değil. Boş bırakmak «sayfada vade yazmıyor» iddiasıdır ve yanlıştır (`0203-cfc1e9a26a6c` «36 aya varan», `0205-6ffd7be261ce` «48 aya varan», `0205-54bc08fa0088` «60 aya kadar», `0206-4db63f5eca2f` «maksimum vadesi 120 ay») |
